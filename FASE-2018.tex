...
\begin{figure}	
	\begin{subfigure}[t]{0.5\linewidth}
		\includegraphics[width=\linewidth]{append_speed_log}
		\caption{Node model}\label{fig:append_speed_tree}		
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.5\linewidth}
		\includegraphics[width=\linewidth]{append_speed_log}
	...
	\end{subfigure}
	\caption{A comparison on time used to persist models between CBP and XMI in log scale.}
	\label{fig:append_speed}
\end{figure}

%\begin{figure}
%\begin{subfigure}[Linear scale]{\includegraphics[width=0.5\linewidth]{append_speed}}
%\label{aaa}
%\end{subfigure}
%\subfigure[Log scale]{\includegraphics[width=0.5\linewidth]{append_speed_log}}
